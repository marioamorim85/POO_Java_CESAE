...
O repositório está organizado por aulas e fichas de trabalho:

- `Aula1/`: Introdução ao Java e conceitos iniciais.
- `Aula2/`: Aprofundamento em classes e objetos.
- `Aula3/`: Exercícios avançados e novas temáticas.
- `PL01/`: Ficha de Trabalho 01 - Introdução e Sintaxe Base.
...
- **Build Tool:** Maven / Gradle (se aplicável)
